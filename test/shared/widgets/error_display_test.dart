...
void main() {
  group('ErrorDisplay Widget Tests', () {
    testWidgets('ErrorDisplay: should display the default error message', (
      tester,
    ) async {
    ...
    testWidgets('ErrorDisplay: should display a custom error message', (
      tester,
    ) async {
    ...
    testWidgets(
      'ErrorDisplay: should display retry button when onRetry is provided',
      (tester) async {
