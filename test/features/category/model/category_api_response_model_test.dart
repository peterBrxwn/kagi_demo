...
void main() {
  group('CategoryApiResponseModel', () {
    test(
      'CategoryApiResponseModel: should correctly deserialize from JSON',
      () {
        final json = {
    ...
    test('CategoryApiResponseModel: should correctly serialize to JSON', () {
    ...
    test('CategoryApiResponseModel: should correctly format timestamp', () {
      final model = CategoryApiResponseModel(
        timestamp: 1748867070,
        categories: [],
      );
    ...
    test(
      'CategoryApiResponseModel: should handle invalid timestamp gracefully',
      () {
        final model = CategoryApiResponseModel(timestamp: -1, categories: []);
